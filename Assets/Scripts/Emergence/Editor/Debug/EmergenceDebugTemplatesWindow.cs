...
namespace Emergence
{
    ...
    /// </summary>
    internal sealed class EmergenceDebugTemplatesWindow : EditorWindow
    {
        #region Constants
        ...
        #region Menu
        /// <summary>
        /// Opens the debug templates editor window.
        /// </summary>
        [MenuItem(MenuPath)]
        public static void OpenWindow()
        {
            EmergenceDebugTemplatesWindow window = GetWindow<EmergenceDebugTemplatesWindow>();
            window.titleContent = new GUIContent("Emergence Debug Templates");
        ...
        /// <summary>
        /// Handles selection changes for the templates asset.
        /// </summary>
        ...
        /// <summary>
        /// Rebuilds the inspector section for the selected asset.
        /// </summary>
        ...
        /// <summary>
        /// Creates a new debug templates asset in the default folder.
        /// </summary>
        ...
        /// <summary>
        /// Ensures the target folder hierarchy exists.
        /// </summary>
